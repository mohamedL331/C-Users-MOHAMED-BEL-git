...
String[] Affichage = {"Mot reserve debut du programme", " Mot reserve  declaration d'un entier","caractere reservé","identificateur","caractere reserve","identificateur","caractere reservé","identificateur","mot reservé",
		"mot reservé",
		
		"Mot reservé","identificateur","caractere reservé","valeur entiere",
"Déclaration d'un reel","caractere reservé","identificateur","mot reservé",

" Mot reserve pour condition SI", "Mot reserve pour condition","identificateur","symbole inferieur",
"identificateur","mot reservé pour une condition  "
,"mot reservé","identificateur","caractere reservé","valeur entiere","mot reservé", "Mot reserve pour condition SINON", 
"Debut d'un sous programme","Affectation de valeur entre variable","identificateur","a","identificateur","mot reservé",
"Mot reserve ","identificateur","mot reservé", "identificateur","caractere reservé","valeur reele","mot reservé", "Fin d'un sous programme",
"Mot reservé pour afficher un message a l'ecran","Affichage d'une valeur", "Example de commentaire", "Mot reserve Fin du programme" 
};
		int i = 0;
...
/*********************************************************************************************************************/
	...
	private void initialize() {
		...
		frmMonAnalyseur.setTitle("Analyseur lexicale,syntaxique et semantique créé par:BELHERAZ&BOUKOR");
